...
UBUNTU_TRANSLATION_DOMAIN="networkstatus.liu-xiao-guo"
...
aptest.commands = bash $$PWD/networkstatus/tests/autopilot/run
aptest.depends  = sub-networkstatus

unittest.target   = check
unittest.commands = /usr/bin/qmltestrunner -input $$PWD/networkstatus/tests/unit
unittest.depends  = sub-networkstatus
